...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Seats',
            fields=[
                ('aircraft_code', models.OneToOneField(db_column='aircraft_code', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='home.AircraftsData')),
        ...
        migrations.CreateModel(
            name='TicketFlights',
            fields=[
                ('ticket_no', models.OneToOneField(db_column='ticket_no', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='home.Tickets')),
                ('fare_conditions', models.CharField(max_length=10)),
        ...
        migrations.CreateModel(
            name='BoardingPasses',
            fields=[
                ('ticket_no', models.OneToOneField(db_column='ticket_no', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='home.TicketFlights')),
